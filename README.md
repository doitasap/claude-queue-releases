...
- macOS 12 이상
- [Claude Code CLI](https://code.claude.com/docs/en/setup) 선설치 — 이 앱은 공식 CLI를 실행할 뿐,
  자체적으로 Claude를 호출하지 않습니다.

## 개인정보

데이터를 수집하지 않습니다. 모든 작업 기록은 사용자 컴퓨터에만 저장됩니다.
자세한 내용은 [개인정보 처리방침](privacy.md)을 참고하십시오.
